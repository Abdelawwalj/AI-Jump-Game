...
const player = {
  ...
  velocityY: 0,
  isJumping: false,
  speed: 4, // Start snelheid, zelfde als de rechter pijltoets
  jumpHeight: 12,
  score: 0,
  currentImage: null,
  explosionCounter: 0,
...
function handlePlayerMovement() {
  ...
  player.speed += 0.001; // Verhoog de snelheid geleidelijk naarmate het spel vordert
}
